...
public record TaskDetailResponse(
  ...
  LocalDateTime createdAt, LocalDateTime updatedAt
    ...
    public static TaskDetailResponse toDto(
            Long id, String title, String description, LocalDateTime dueDate,
            String priority, String status, Long assigneeId, UserResponseDto assignee,
            LocalDateTime createdAt, LocalDateTime updatedAt
    ) {
        return new TaskDetailResponse(id, title, description, dueDate, priority, status, assigneeId, assignee, createdAt, updatedAt);
    }
